...
security::security(int r= 0,string cryp= " ")           //A constructor method with "r" initialized with 0 and "cryp" initialized with a space.
{
  rot = r;     //Set attributes equal to the initial values.
  cryptogram = cryp;
}
